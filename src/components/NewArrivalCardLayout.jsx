...
const NewArrivalCardLayout = () => {
  return (
    <>
      <div className="flex flex-col bg-white items-center justify-center mt-16">
        <h2 className="text-5xl pl-5 font-bold lg:pl-0">New Arrival Products</h2>

        <p className="text-gray-400 py-5">There are many variations passages</p>
      </div>
                ...
                <div className="border border-gray-300 aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-3xl bg-[#ffffff] xl:aspect-h-8 xl:aspect-w-7">
                  ...
                  <div className="mt-72 flex  justify-center ">
                    ...
                    <div className="absolute mt-6">
                      <Button title={"Add To Cart"} border="b" />
                    </div>
                  </div>
                </div>
              </a>
...
export default NewArrivalCardLayout;
